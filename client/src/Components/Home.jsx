  ...
  return (
    <div className="bg-[#051622] min-h-screen flex flex-col items-center py-5">
      <header className="w-full bg-[#051622] py-4 fixed top-0 left-0 z-10 shadow-lg">
        <nav className="flex flex-wrap justify-between items-center max-w-6xl mx-auto px-5">
      ...
      <div className="container mx-auto px-5 py-5 mt-20 max-w-4xl">
        ...
        <div className="flex justify-around mb-16 flex-wrap">
          <button
            onClick={() => navigate('/savedContacts')}
            className="bg-[#deb992] text-black px-10 py-4 rounded-lg hover:bg-[#c8a063] transition mb-4 md:mb-0"
          >
            Saved Contacts
          </button>
          <button
